...
## 📋 Introducción
Guía paso a paso para recrear el diseño de la landing page "DesignPro" en Figma. Es una demostración de composición: aplica después las técnicas a tu propio proyecto de la [actividad 21](Actividades.md#actividad-21). Las medidas son valores del ejemplo, no reglas universales.
...
3. **Añadir una versión estrecha** de la página y comprobar cómo se reorganiza el contenido. No basta con reducir proporcionalmente el diseño de escritorio.
